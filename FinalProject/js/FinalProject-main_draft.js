...
var dataset3 = "https://raw.githubusercontent.com/wenhaowuuu/FinalProject/master/FinalProject/data/china_provincies_def.geojson";
    ...
    layerMappedPolygons = L.geoJson(parsedData3,
      {
        ...
        pointToLayer: function (feature, latlngs) {
          ...
          }}).bindPopup(feature.properties.provincie);
    }).addTo(map);
});
